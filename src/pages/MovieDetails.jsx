...
function MovieDetails() {
  ...
  const rottenRating =
    currentMovie.Ratings?.find((rating) => rating.Source === "Rotten Tomatoes")
      ?.Value || "N/A";
  const metaRating =
    currentMovie.Ratings?.find((rating) => rating.Source === "Metacritic")
      ?.Value || "N/A";

  // High-resolution backdrop based on movie title for larger screens
  const backdropUrl =
    currentMovie.Poster !== "N/A" ? currentMovie.Poster : "/placeholder.jpg";
    ...
    >
      ...
      <div
        style={{
          position: "relative",
          height:
            screenWidth <= 480 ? "55vh" : screenWidth <= 768 ? "60vh" : "70vh",
          overflow: "hidden",
        }}
      >
        <motion.div
      ...
      <div
        style={{
          ...
          position: "relative",
          zIndex: 3000,
          marginTop: screenWidth <= 768 ? "-190px" : "-200px",
        }}
      >
        <motion.div
              ...
              >
                ...
                {metaRating !== "N/A" && (
                  ...
                  >
                    ...
                    >
                      <span style={{ color: "#5799EF", fontWeight: "bold" }}>
                        M
                      </span>
